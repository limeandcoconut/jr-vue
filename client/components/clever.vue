    ...
    <article id="page-container">
        ...
        <div class="rc-anchor rc-anchor-normal rc-anchor-light">
            <div class="rc-anchor-aria-status">
                <section>
                    <h1>recaptcha status</h1>
                    <span id="recaptcha-accessible-status" aria-live="assertive" aria-atomic="true">Verification challenge expired, check the checkbox again for a new challenge</span>
                </section>
            </div>
            ...
            <div class="rc-anchor-content">
                <div class="rc-inline-block">
                    <div class="rc-anchor-center-container">
                        <div class="rc-anchor-center-item rc-anchor-checkbox-holder">
                            <span @click="foo" v-el:checkbox :class="{ 'recaptcha-checkbox-checked': isChecked }" class="recaptcha-checkbox goog-inline-block recaptcha-checkbox-unchecked rc-anchor-checkbox" role="checkbox" aria-checked="false" id="recaptcha-anchor" dir="ltr" aria-labelledby="recaptcha-anchor-label" aria-disabled="false" tabindex="0">
                            <span @click="foo" v-el:checkbox :class="{ 'recaptcha-checkbox-checked': isChecked, 'recaptcha-checkbox-unchecked': !isChecked }" class="recaptcha-checkbox goog-inline-block rc-anchor-checkbox" id="recaptcha-anchor" tabindex="0">
                ...
                <div class="rc-inline-block">
                    <div class="rc-anchor-center-container">
                        <label class="rc-anchor-center-item rc-anchor-checkbox-label" id="recaptcha-anchor-label">I'm not a robot</label>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        foo(event) {
            ...
            // let check = document.getElementsByClassName("recaptcha-checkbox-checkmark")[0];
            // console.log(this.$els.checkbox);
            // console.log(this.$els.checkbox.className);
            // this.$els.checkbox += ' recaptcha-checkbox-checked';
            this.isChecked = true;
...
.rc-badge-text strong {
    font-weight: 500
}
.rc-badge .rc-anchor-pt {
    margin: 4px 0 0 0
}
.rc-badge .rc-anchor-pt a:link,
.rc-badge .rc-anchor-pt a:visited {
    text-decoration: none;
    color: white;
    font-size: 10px
}
.rc-badge .rc-anchor-pt a:hover {
    text-decoration: underline
}
.rc-button-default {
    background: #4a90e2;
...
.rc-button-default-hover {}.rc-button-default-disabled {
...
.report-captcha-button-holder {
    margin: 6px 20px 10px 20px
}
.rc-report-captcha-button {
    background-color: #d14836;
    clear: both;
    padding: 0;
    width: 100%
}
.rc-report-captcha-button.rc-button-default-disabled {
    opacity: .5
}
.rc-challenge-help {
    font-family: Roboto, helvetica, arial, sans-serif;
...
.rc-report-problem-text:hover {
    cursor: pointer;
    text-decoration: underline
}
.rc-report-problem-section {
    font-size: 14px;
    padding: 10px;
    position: relative
}
.rc-report-problem-options .jfk-radiobutton {
    margin-top: 10px
}
.rc-report-close {
    position: absolute;
    ...
    display: inline-block;
    top: 5px;
    background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAQAAABKfvVzAAAAeUlEQVQ4y+WTyw2AIBAFbQKK8FPelAdFANaDB4i6WVA8y5HMLJuXxzT9+7DhMOrW4lnagicTpYJlJ+PagiFKpeJBv3spiUwqwCsuFDuE17lFGcNvq4zin4Vz96hDfsKNDvkR1yG/4jLkfjWCqkYi49vC2i3f/PN/eQCFYXfuPNt44gAAAABJRU5ErkJggg==)
}
.apps-toast {
    position: relative;
    text-align: center;
...
.rc-audiochallenge-download-link:focus,
.rc-audiochallenge-download-link:hover {
    opacity: .8
}
...
.rc-imageselect-target>div:hover {}.rc-imageselect-response-field-error {
